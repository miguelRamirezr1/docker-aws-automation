...
st.set_page_config(page_title="Muro Social", layout="wide")
...
if not st.session_state.logged_in:
    st.warning("Debes iniciar sesión para ver y publicar en el muro")
    ...
    with col_main:
        # Crear nuevo post
        st.markdown("### ¿Qué estás pensando?")
        ...
        with st.form("nuevo_post_form", clear_on_submit=True):
            ...
            if publicar and contenido_post:
                ...
                nuevo_post = {
                    ...
                    "imagen": "Imagen de ejemplo" if incluir_imagen else None,
...
with st.sidebar:
    ...
    - {random.randint(1000, 5000)} likes hoy
    """)

    st.markdown("---")

    st.markdown("### Sobre el Muro")
    st.markdown("""
